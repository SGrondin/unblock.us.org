/*** Generated by streamline 0.10.8 (callbacks) - DO NOT EDIT ***/ var __rt=require('streamline/lib/callbacks/runtime').runtime(__filename, false),__func=__rt.__func,__cb=__rt.__cb,__catch=__rt.__catch,__tryCatch=__rt.__tryCatch; (function() {
  var Bottleneck, TCPserver, UDPserver, handlerTCP, handlerUDP, libDNS, libTCP, libUDP, limiterTCP, limiterUDP, serverStarted, services, stats, tcp, udp, util;
  ...
  handlerUDP = function handlerUDP__1(data, info, _) { var answer, err, parsed, resData, resInfo, _ref; var __frame = { name: "handlerUDP__1", line: 80 }; return __func(_, this, arguments, handlerUDP__1, 2, __frame, function __$handlerUDP__1() {
            ...
            answer = libDNS.getAnswer(parsed); return (function __$handlerUDP__1(__then) {
              if ((answer != null)) {
                resData = answer; __then(); } else { return (function __$handlerUDP__1(_) {
                  ...
                  return libUDP.forwardGoogleUDP(data, limiterUDP, __cb(_, __frame, 10, 15, function ___(__0, __1) { _ref = __1; resData = _ref[0]; return _(null, resInfo = _ref[1]); }, true, true)); })(__cb(_, __frame, -79, 7, __then, true)); } ; })(function __$handlerUDP__1() {
  ...
  handlerTCP = function handlerTCP__2(c, _) { var answer, data, err, google, parsed; var __frame = { name: "handlerTCP__2", line: 118 }; return __func(_, this, arguments, handlerTCP__2, 1, __frame, function __$handlerTCP__2() {
