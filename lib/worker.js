/*** Generated by streamline 0.10.8 (callbacks) - DO NOT EDIT ***/ var __rt=require('streamline/lib/callbacks/runtime').runtime(__filename, false),__func=__rt.__func,__cb=__rt.__cb,__catch=__rt.__catch,__tryCatch=__rt.__tryCatch; (function() {
  var Bottleneck, HTTPSserver, HTTPserver, TCPserver, UDPserver, handlerHTTP_S, handlerTCP, handlerUDP, libDNS, libTCP, libUDP, limiterTCP, limiterUDP, serverStarted, services, stats, stream, tcp, udp, util;
  ...
  handlerHTTP_S = function handlerHTTP_S__3(c, port, _) { var google; var __frame = { name: "handlerHTTP_S__3", line: 169 }; return __func(_, this, arguments, handlerHTTP_S__3, 2, __frame, function __$handlerHTTP_S__3() {
