/*** Generated by streamline 0.10.8 (callbacks) - DO NOT EDIT ***/ var __rt=require('streamline/lib/callbacks/runtime').runtime(__filename, false),__func=__rt.__func,__cb=__rt.__cb,__catch=__rt.__catch,__tryCatch=__rt.__tryCatch; (function() {
  ...
  handlerUDP = function handlerUDP__1(data, info, _) { var answer, err, parsed, resData, resInfo, _ref; var __frame = { name: "handlerUDP__1", line: 93 }; return __func(_, this, arguments, handlerUDP__1, 2, __frame, function __$handlerUDP__1() {
            ...
            answer = libDNS.getAnswer(parsed); return (function __$handlerUDP__1(__then) {
              if ((answer != null)) {
                resData = answer; __then(); } else { return (function __$handlerUDP__1(_) {
                  ...
                  return libUDP.forwardGoogleUDP(data, limiterUDP, __cb(_, __frame, 10, 15, function ___(__0, __1) { _ref = __1; resData = _ref[0]; return _(null, resInfo = _ref[1]); }, true, true)); })(__cb(_, __frame, -92, 7, __then, true)); } ; })(function __$handlerUDP__1() {
              ...
              return libUDP.sendUDP(UDPserver, info.address, info.port, libDNS.makeDNS(parsed, libDNS.SERVERFAILURE), __cb(_, __frame, 17, 6, function __$handlerUDP__1() {
                return _(null, console.log(err.stack)); }, true)); } else { _(null, __result); } ; }); }); })(function ___() { __tryCatch(_, function __$handlerUDP__1() { _(); }); }); }); };
  ...
  handlerTCP = function handlerTCP__2(c, _) { var answer, data, err, google, parsed; var __frame = { name: "handlerTCP__2", line: 131 }; return __func(_, this, arguments, handlerTCP__2, 1, __frame, function __$handlerTCP__2() {
  ...
  handlerHTTPS = function handlerHTTPS__3(c, _) { var err, host, received, stream, _ref; var __frame = { name: "handlerHTTPS__3", line: 180 }; return __func(_, this, arguments, handlerHTTPS__3, 1, __frame, function __$handlerHTTPS__3() {

      stats.nbRequestHTTPS++;
      stats.nbRequestHTTPSStart++; return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$handlerHTTPS__3() { return (function __$handlerHTTPS__3(_) {

              return libHTTPS.getRequest(c, __cb(_, __frame, 5, 13, function ___(__0, __1) { _ref = __1; host = _ref[0]; return _(null, received = _ref[1]); }, true, true)); })(__cb(_, __frame, -179, 7, function __$handlerHTTPS__3() {
              return libHTTPS.getHTTPSstream(host, __cb(_, __frame, 6, 15, function ___(__0, __1) { stream = __1;
                con(host);
                stream.write(received);
                c.pipe(stream).pipe(c);
                return _(null, c.resume()); }, true)); }, true)); }); })(function ___(_error, __result) { __catch(function __$handlerHTTPS__3() { if (_error) {
              ...
              c.destroy();
              return _(null, stream.destroy()); } else { _(null, __result); } ; }); }); })(function ___() { __tryCatch(_, function __$handlerHTTPS__3() { _(); }); }); }); };
  ...
  setInterval(function() {
    con(process.pid, "UDP", ((stats.nbFailUDP + "/") + stats.nbRequestUDP), "UDPStart", ((stats.nbFailUDPStart + "/") + stats.nbRequestUDPStart), "TCP", ((stats.nbFailTCP + "/") + stats.nbRequestTCP), "TCPStart", ((stats.nbFailTCPStart + "/") + stats.nbRequestTCPStart), "HTTPS", ((stats.nbFailHTTPS + "/") + stats.nbRequestHTTPS), "HTTPSStart", ((stats.nbFailHTTPSStart + "/") + stats.nbFailHTTPSStart));
