/*** Generated by streamline 0.10.8 (callbacks) - DO NOT EDIT ***/ var __rt=require('streamline/lib/callbacks/runtime').runtime(__filename, false),__func=__rt.__func,__cb=__rt.__cb,__catch=__rt.__catch,__tryCatch=__rt.__tryCatch; (function() {
  var Bottleneck, HTTPSserver, TCPserver, UDPserver, handlerHTTPS, handlerTCP, handlerUDP, libDNS, libHTTPS, libTCP, libUDP, limiterHTTPS, limiterTCP, limiterUDP, serverStarted, services, settings, shutdown, stats, tcp, udp, util;
  ...
  shutdown = function shutdown__1(cause, _) { var f1, f2; var __frame = { name: "shutdown__1", line: 61 }; return __func(_, this, arguments, shutdown__1, 1, __frame, function __$shutdown__1() {
  ...
  handlerUDP = function handlerUDP__2(data, info, _) { var answer, e, err, parsed, resData, resInfo, _ref; var __frame = { name: "handlerUDP__2", line: 114 }; return __func(_, this, arguments, handlerUDP__2, 2, __frame, function __$handlerUDP__2() {
            ...
            answer = libDNS.getAnswer(parsed); return (function __$handlerUDP__2(__then) {
              if ((answer != null)) {
                resData = answer; __then(); } else { return (function __$handlerUDP__2(_) {
                  ...
                  return libUDP.forwardGoogleUDP(data, limiterUDP, __cb(_, __frame, 10, 15, function ___(__0, __1) { _ref = __1; resData = _ref[0]; return _(null, resInfo = _ref[1]); }, true, true)); })(__cb(_, __frame, -113, 7, __then, true)); } ; })(function __$handlerUDP__2() {
              ...
              stats.nbFailUDPStart++; return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$handlerUDP__2() {
                    ...
                    return libUDP.sendUDP(UDPserver, info.address, info.port, libDNS.makeDNS(parsed, libDNS.SERVERFAILURE), __cb(_, __frame, 18, 8, __then, true)); }); })(function ___(_error, __result) { __catch(function __$handlerUDP__2() { if (_error) {

                      e = _error; __then(); } else { _(null, __result); } ; }); }); })(function ___() { __tryCatch(_, function __$handlerUDP__2() {

                  return _(null, console.log(err.message)); }); }); } else { _(null, __result); } ; }); }); })(function ___() { __tryCatch(_, function __$handlerUDP__2() { _(); }); }); }); };
  ...
  handlerTCP = function handlerTCP__3(c, _) { var answer, data, err, google, parsed; var __frame = { name: "handlerTCP__3", line: 156 }; return __func(_, this, arguments, handlerTCP__3, 1, __frame, function __$handlerTCP__3() {
  ...
  handlerHTTPS = function handlerHTTPS__4(c, _) { var err, host, received, stream, _ref; var __frame = { name: "handlerHTTPS__4", line: 203 }; return __func(_, this, arguments, handlerHTTPS__4, 1, __frame, function __$handlerHTTPS__4() {
      ...
      stats.nbRequestHTTPSStart++; return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$handlerHTTPS__4() { return (function __$handlerHTTPS__4(_) {
              ...
              return libHTTPS.getRequest(c, __cb(_, __frame, 5, 13, function ___(__0, __1) { _ref = __1; host = _ref[0]; return _(null, received = _ref[1]); }, true, true)); })(__cb(_, __frame, -202, 7, function __$handlerHTTPS__4() {
              ...
              return limiterHTTPS.submit(libHTTPS.getHTTPSstream, host, __cb(_, __frame, 9, 15, function ___(__0, __1) { stream = __1;
                ...
                return _(null, c.resume()); }, true)); }, true)); }); })(function ___(_error, __result) { __catch(function __$handlerHTTPS__4() { if (_error) {
