/*** Generated by streamline 0.10.12 (callbacks) - DO NOT EDIT ***/ var __rt=require('streamline/lib/callbacks/runtime').runtime(__filename, false),__func=__rt.__func,__cb=__rt.__cb; (function() {
  ...
  redirectAllURLs = function redirectAllURLs__2(str, redisClient, clientIP, hashCache, _) { var __frame = { name: "redirectAllURLs__2", line: 56 }; return __func(_, this, arguments, redirectAllURLs__2, 4, __frame, function __$redirectAllURLs__2() {
      return asyncReplace(str, rDomains, (function __1(found, f2, f3, _) { var formatted, hash, parsed; var __frame = { name: "__1", line: 57 }; return __func(_, this, arguments, __1, 3, __frame, function __$__1() {
          ...
          if ((parsed.protocol != null)) {
            ...
            if ((formatted.slice(0, 2) === "//")) {
              return _(null, formatted.slice(2)); }
             else {
              return _(null, formatted); } ; _(); }); }); }), __cb(_, __frame, 1, 11, _, true)); }); };
