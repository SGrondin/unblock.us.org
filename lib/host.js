/*** Generated by streamline 0.10.12 (callbacks) - DO NOT EDIT ***/ var __rt=require('streamline/lib/callbacks/runtime').runtime(__filename, false),__func=__rt.__func,__cb=__rt.__cb; (function() {
  var Bottleneck, a, asyncReplace, contentTypes, crypto, getHash, isAltered, rDomains, rDots, rLookbehind, redirectAllURLs, redirectToHash, settings, url;
  ...
  redirectAllURLs = function redirectAllURLs__2(str, redisClient, clientIP, _) { var limiter; var __frame = { name: "redirectAllURLs__2", line: 66 }; return __func(_, this, arguments, redirectAllURLs__2, 3, __frame, function __$redirectAllURLs__2() {

      limiter = new Bottleneck(1);
      return asyncReplace(str, rDomains, (function __1(whole, lookbehind, found, position, text, _) { var backslashes, formatted, hash, parsed; var __frame = { name: "__1", line: 69 }; return __func(_, this, arguments, __1, 5, __frame, function __$__1() {

          if (!rLookbehind.test(lookbehind)) {
            return _(null, found); } ;

          backslashes = ((found.indexOf("\\") > 0) ? true : false);
          ...
          return limiter.submit(getHash, redisClient, parsed.hostname, clientIP, __cb(_, __frame, 16, 21, function ___(__0, __1) { hash = __1;
            ...
            if (backslashes) {
              formatted = formatted.replace(rDots, "\\."); } ;

            return _(null, (lookbehind + formatted)); }, true)); }); }), __cb(_, __frame, 3, 11, _, true)); }); };
