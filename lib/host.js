/*** Generated by streamline 0.10.12 (callbacks) - DO NOT EDIT ***/ var __rt=require('streamline/lib/callbacks/runtime').runtime(__filename, false),__func=__rt.__func,__cb=__rt.__cb; (function() {
  ...
  redirectAllURLs = function redirectAllURLs__2(str, redisClient, clientIP, _) { var limiter; var __frame = { name: "redirectAllURLs__2", line: 64 }; return __func(_, this, arguments, redirectAllURLs__2, 3, __frame, function __$redirectAllURLs__2() {
      ...
      return asyncReplace(str, rDomains, (function __1(found, lookbehind, position, text, _) { var formatted, hash, parsed; var __frame = { name: "__1", line: 67 }; return __func(_, this, arguments, __1, 4, __frame, function __$__1() {
          ...
          return limiter.submit(getHash, redisClient, parsed.hostname, clientIP, __cb(_, __frame, 18, 21, function ___(__0, __1) { hash = __1;
            ...
            if ((formatted.slice(0, 2) === "//")) {
              ...
              return _(null, (lookbehind + formatted)); } ; _(); }, true)); }); }), __cb(_, __frame, 3, 11, _, true)); }); };
