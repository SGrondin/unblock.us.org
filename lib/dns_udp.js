(function() {
  ...
  forwardUDP = function(data, limiterUDP, cb) {
    ...
    return limiterUDP.submit(sendUDP, null, settings.forwardDNS, settings.forwardDNSPort, data, function(err, resData, resInfo) {
      if (err != null) {
        nbErrors++;
      }
