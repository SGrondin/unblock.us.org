/*** Generated by streamline 0.10.9 (callbacks) - DO NOT EDIT ***/ var __rt=require('streamline/lib/callbacks/runtime').runtime(__filename, false),__func=__rt.__func,__cb=__rt.__cb; (function() {
  ...
  interval = function interval__1(_) { var __frame = { name: "interval__1", line: 26 }; return __func(_, this, arguments, interval__1, 0, __frame, function __$interval__1() {
      return (redisClient.mget(stats, __cb(_, __frame, 1, 24, function ___(__0, __3) { return __3.forEach_(__cb(_, __frame, 1, 40, _, true), -1, function __1(_, s, i) { var __frame = { name: "__1", line: 27 }; return __func(_, this, arguments, __1, 0, __frame, function __$__1() {
            return redisClient.mset((stats[i] + ".last"), s, stats[i], 0, __cb(_, __frame, 1, 25, _, true)); }); }); }, true))); }); };
