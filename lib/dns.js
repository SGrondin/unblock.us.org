(function() {
  var CLASSES, NAMEERROR, SERVERFAILURE, TYPES, bitconcat, getAnswer, getClass, getType, make2Bytes, makeDNS, parse2Bytes, parseDNS, prependLength, redirected_types, redirection, settings;
