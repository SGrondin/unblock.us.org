(function() {
  var CLASSES, IPv4, NAMEERROR, SERVERFAILURE, TYPES, bitconcat, getAnswer, getClass, getType, make2Bytes, makeDNS, parse2Bytes, parseDNS, prependLength, redirects;
  ...
  getAnswer = function(parsed, isTCP) {
    ...
    if ((((_ref = redirects[domain]) != null ? _ref[parsed.QUESTION.TYPE] : void 0) != null) && parsed.QUESTION.CLASS === "IN") {
      return makeDNS(parsed, redirects[domain][parsed.QUESTION.TYPE], isTCP);
    } else {
      return null;
    }
  };
