(function() {
  var CLASSES, IPv4, IPv6, NAMEERROR, SERVERFAILURE, TYPES, bitconcat, getAnswer, getClass, getType, make2Bytes, makeDNS, parse2Bytes, parseDNS, prependLength, redirected_types, redirection, settings;
  ...
  getAnswer = function(parsed, isTCP) {
    ...
    if ((settings.redirected_domains[domain] != null) && (redirected_types[parsed.QUESTION.TYPE] != null) && parsed.QUESTION.CLASS === "IN") {
      con(parsed.QUESTION.NAME.join("."), parsed.QUESTION.CLASS, parsed.QUESTION.TYPE);
