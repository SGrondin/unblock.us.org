/*** Generated by streamline 0.10.8 (callbacks) - DO NOT EDIT ***/ var __rt=require('streamline/lib/callbacks/runtime').runtime(__filename, false),__func=__rt.__func,__cb=__rt.__cb,__catch=__rt.__catch,__tryCatch=__rt.__tryCatch; (function() {
  ...
  handlerUDP = function handlerUDP__1(data, info, _) { var done, err, resData, resInfo, timeoutFail, _ref; var __frame = { name: "handlerUDP__1", line: 70 }; return __func(_, this, arguments, handlerUDP__1, 2, __frame, function __$handlerUDP__1() {
      ...
      timeoutFail = setTimeout(function() {
        stats.nbFailUDP++;
        return stats.nbFailUDPStart++;
      }, 3000); return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$handlerUDP__1() { return (function __$handlerUDP__1(_) {

              return libUDP.forwardGoogleUDP(data, limiterUDP, __cb(_, __frame, 10, 13, function ___(__0, __1) { _ref = __1; resData = _ref[0]; return _(null, resInfo = _ref[1]); }, true, true)); })(__cb(_, __frame, -69, 7, function __$handlerUDP__1() {
              return libUDP.sendUDP(UDPserver, info.address, info.port, resData, __cb(_, __frame, 11, 6, function __$handlerUDP__1() {
                return _(null, clearTimeout(timeoutFail)); }, true)); }, true)); }); })(function ___(_error, __result) { __catch(function __$handlerUDP__1() { if (_error) {
