/*** Generated by streamline 0.10.8 (callbacks) - DO NOT EDIT ***/ var __rt=require('streamline/lib/callbacks/runtime').runtime(__filename, false),__func=__rt.__func,__cb=__rt.__cb,__catch=__rt.__catch,__tryCatch=__rt.__tryCatch; (function() {
  ...
  handlerUDP = function handlerUDP__1(data, info, _) { var err, resData, resInfo, _ref; var __frame = { name: "handlerUDP__1", line: 70 }; return __func(_, this, arguments, handlerUDP__1, 2, __frame, function __$handlerUDP__1() {
      ...
      stats.nbRequestUDPStart++; return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$handlerUDP__1() { return (function __$handlerUDP__1(_) {
              ...
              return libUDP.forwardGoogleUDP(data, limiterUDP, __cb(_, __frame, 5, 13, function ___(__0, __1) { _ref = __1; resData = _ref[0]; return _(null, resInfo = _ref[1]); }, true, true)); })(__cb(_, __frame, -69, 7, function __$handlerUDP__1() {
  ...
  handlerTCP = function handlerTCP__2(c, _) { var err; var __frame = { name: "handlerTCP__2", line: 91 }; return __func(_, this, arguments, handlerTCP__2, 1, __frame, function __$handlerTCP__2() { return (function ___(__then) { (function ___(_) { __tryCatch(_, function __$handlerTCP__2() {
  ...
  handlerHTTPS = function handlerHTTPS__3(c, _) { var __frame = { name: "handlerHTTPS__3", line: 122 }; return __func(_, this, arguments, handlerHTTPS__3, 1, __frame, function __$handlerHTTPS__3() { _(); }); };
